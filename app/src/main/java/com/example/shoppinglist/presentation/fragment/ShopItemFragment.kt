...
import com.example.shoppinglist.presentation.stateholder.ShopItemViewModel
...
class ShopItemFragment : Fragment() {
    ...
    private fun launchAddMode() {
        binding.saveButton.setOnClickListener {
            viewModel.insertItem(binding.etName.text?.toString(), binding.etCount.text?.toString())
        }
    }
